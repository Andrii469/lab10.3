...
void Print_File(const string File_Name)
{
	...
	for (int i = 0; i < counter / 4; i++)
	{
		...
		cout << "|" << setw(10) << line << setw(9); // назва магаз

		f.getline(line, sizeof(line));
		cout << "|" << setw(10) << line << setw(7); // назва товару

		f.getline(line, sizeof(line));
		cout << "|" << setw(10) << line << setw(9); // ціна товару

		f.getline(line, sizeof(line));
		cout << "|" << setw(10) << line << setw(12) << "|" << endl; // кількість товару		
	}
